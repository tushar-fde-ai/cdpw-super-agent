    ...
    <div>
      ...
      >
        ...
        {message.metadata?.attachedFile && (
          <motion.div
            className="mt-2 flex items-center space-x-2 text-xs text-black bg-gray-100 rounded-lg px-3 py-2"
          ...
          >
            ...
            <span className="text-gray-600">({message.metadata.attachedFile.type})</span>
          </motion.div>
        )}
      </MessageBubble>
    </div>
